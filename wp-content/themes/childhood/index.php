...
?>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('dont_find_span') ?></span><?php the_field('dont_find') ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contacts" id="contacts">
            <h1 class="title"><?php the_field('our_geo-title') ?></h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined"><?php the_field('our_geo-descr') ?></div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('tel1', 2) ?>"><?php the_field('tel1', 2) ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('tel2', 2) ?>"><?php the_field('tel2', 2) ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                        	<?php echo do_shortcode('[contact-form-7 id="137" title="Форма отзыва"]'); ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
                                ...
                                foreach( $posts as $post ){
                                    ...
                                    <li class="glide__slide">
                                        ...
                                        <div class="feedslider__text">
                                            <?php the_field('feedslider_descr'); ?>
                                        </div>
                                    </li>
